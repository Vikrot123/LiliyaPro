...
class LiliyaRuntime {
    ...
    private val reasoningEngine = ReasoningEngineImpl()

    private val planningEngine = PlanningEngineImpl()

    private val reflectionEngine = ReflectionEngineImpl()

    private val goalManager = GoalManagerImpl()
