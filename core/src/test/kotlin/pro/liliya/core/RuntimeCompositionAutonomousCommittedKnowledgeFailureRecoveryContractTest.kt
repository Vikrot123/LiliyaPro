...
class RuntimeCompositionAutonomousCommittedKnowledgeFailureRecoveryContractTest {

    @Test
    fun autonomous_committed_knowledge_survives_failure_recovery() {
        val composition =
        ...
        composition.markRuntimeFailed(
            "v1.516-autonomous-knowledge-failure-boundary"
        )

        assertEquals(
            CoreRuntimeState.FAILED,
            composition.runtimeState(),
            "runtime must enter FAILED before autonomous knowledge recovery"
        )
        ...
        assertSame(
            ...
            memoryAfterRecovery,
            "failure recovery boundary must preserve knowledge lifecycle memory owner"
        )
        ...
        assertTrue(
            ...
            "autonomous knowledge created before recovery must survive failed runtime recovery"
        )
