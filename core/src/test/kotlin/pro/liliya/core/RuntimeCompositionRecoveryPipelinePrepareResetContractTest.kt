...
class RuntimeCompositionRecoveryPipelinePrepareResetContractTest {

    @Test
    fun prepare_after_stop_resets_recovery_pipeline_without_duplicate_delivery() {
        ...
        println("RECOVERED EVENTS = $recovered")
